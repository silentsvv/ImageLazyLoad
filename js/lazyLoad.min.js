...
LazyLoad.prototype.checkInView = function (ele, viewport) {
    ...
    return rect.right * self.option.rectScale >= viewport.left && rect.bottom * self.option.rectScale >= viewport.top && rect.left * self.option.rectScale <= viewport.right && rect.top * self.option.rectScale <= viewport.bottom;
};
